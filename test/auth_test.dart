...
void main() {
  group('Mock Authentcation', () {
    ...
    test('Shoold be able to be initialized', () async {
    ...
    test('Logged in user should be abel to get verified', () {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> login({required String email, required String password}) {
    ...
    const user = AuthUser(isEmailVerified: false, email: 'foobar@bar.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'foobar@gg.com');
    _user = newUser;
  }
}
